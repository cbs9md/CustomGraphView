...
struct DiscreteSlider<Value, Track, Fill, Thumb>: View
        ...
        HStack {
            ...
            .overlay(thumb()
                        ...
                        .gesture(DragGesture(minimumDistance: 0).onChanged({ gestureValue in
                            ...
                            xOffset = trackSize.width * CGFloat((value-bounds.lowerBound)/(bounds.upperBound-bounds.lowerBound))
            ...
            maximumValueLabel
                .onChange(of: value) { newValue in
                    xOffset = trackSize.width * CGFloat((newValue-bounds.lowerBound)/(bounds.upperBound-bounds.lowerBound))
                }
        }
        .onChange(of: bounds) { newBounds in
            xOffset = trackSize.width * CGFloat((value-newBounds.lowerBound)/(newBounds.upperBound-newBounds.lowerBound))
        }
